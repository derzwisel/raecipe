...
@RestController
@RequestMapping("/api/raecipe-kafka")
public class RaecipeKafkaResource {

    private final Logger log = LoggerFactory.getLogger(RaecipeKafkaResource.class);
    ...
    public RaecipeKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
